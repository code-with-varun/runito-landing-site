...
import { Building, Scale, BarChart3, Code, CheckCircle2 } from 'lucide-react';

export const Heritage: React.FC = () => {
  return (
    <section id="enterprise-mis" className="py-20 md:py-28 relative bg-graphite-950/90 border-y border-graphite-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="font-heading text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
            ...
            <span className="text-brandRed-light">Financial Audit Reliability</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="graphite-card graphite-card-hover p-8 rounded-3xl border border-graphite-800 flex flex-col justify-between space-y-6 relative overflow-hidden group">
            <div>
              <div className="w-14 h-14 rounded-2xl bg-graphite-800 border border-slate-700 flex items-center justify-center mb-6 text-brandRed-light group-hover:scale-110 transition-transform">
                <Scale className="w-7 h-7" />
              </div>

              <h3 className="font-heading font-bold text-xl text-white group-hover:text-brandRed-light transition-colors mb-3">
            ...
            <div className="pt-4 border-t border-graphite-800 space-y-2 text-xs font-mono text-slate-400">
