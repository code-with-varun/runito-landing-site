...
export const Calculator: React.FC<CalculatorProps> = ({ onOpenContact }) => {
  ...
  return (
    <section id="calculator" className="py-20 md:py-28 relative border-t border-navy-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="font-heading text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
            Calculate Your <span className="text-corporate-sky">Operational Time & Cost Savings</span>
          </h2>
        ...
        <div className="corporate-card max-w-5xl mx-auto rounded-3xl border border-navy-800 p-6 sm:p-10 grid grid-cols-1 lg:grid-cols-12 gap-8 shadow-2xl">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="flex items-center justify-between border-b border-navy-800 pb-4">
              ...
              {/* Currency Toggle */}
              <div className="flex items-center bg-navy-950 border border-slate-700 rounded-xl p-1 text-xs font-mono">
                <button
                  onClick={() => setCurrency('INR')}
                  className={`px-3 py-1 rounded-lg font-bold transition-colors ${
                    currency === 'INR' ? 'bg-corporate-blue text-white' : 'text-slate-400 hover:text-white'
                  }`}
                >
                  ₹ INR
                </button>
                <button
                  ...
                  className={`px-3 py-1 rounded-lg font-bold transition-colors ${
                    currency === 'USD' ? 'bg-corporate-blue text-white' : 'text-slate-400 hover:text-white'
                  }`}
                >
                  $ USD
                </button>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-xs sm:text-sm font-semibold">
                <label className="text-slate-300 flex items-center space-x-2">
                  <Clock className="w-4 h-4 text-corporate-sky" />
                  <span>Manual Reporting Hours Spent / Week</span>
                </label>
                <span className="font-heading font-black text-xl text-corporate-sky font-mono bg-navy-800 border border-slate-700 px-3 py-1 rounded-xl">
              ...
              <input
                ...
                className="w-full h-2 bg-navy-800 rounded-lg appearance-none cursor-pointer accent-corporate-blue"
              />
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-xs sm:text-sm font-semibold">
                ...
                <span className="font-heading font-black text-xl text-emerald-400 font-mono bg-navy-800 border border-slate-700 px-3 py-1 rounded-xl">
            ...
            {/* Benchmark Note */}
            <div className="bg-navy-950 border border-navy-800 p-4 rounded-2xl text-xs text-slate-400 space-y-1">
          ...
          <div className="lg:col-span-5 bg-navy-950 border border-navy-800 p-6 sm:p-8 rounded-2xl flex flex-col justify-between space-y-6 relative overflow-hidden">
            
            <div className="space-y-6">
              <h4 className="font-heading font-bold text-lg text-white border-b border-navy-800 pb-3">
              ...
              <div className="space-y-1">
                ...
                <p className="font-heading font-black text-3xl sm:text-4xl text-corporate-sky font-mono">
            ...
            <button
              ...
              className="w-full py-3.5 bg-corporate-blue hover:bg-corporate-accent text-white font-heading font-bold rounded-xl text-xs flex items-center justify-center space-x-2 shadow-lg transition-all"
            >
