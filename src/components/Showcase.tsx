...
export const Showcase: React.FC = () => {
  ...
  return (
    <section id="showcase" className="py-20 md:py-28 relative bg-navy-950/60 border-t border-navy-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="font-heading text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
            Flagship Software <span className="text-corporate-sky">Suite & Applications</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((prod) => (
            <div
              ...
              className="corporate-card corporate-card-hover p-8 rounded-3xl border border-navy-800 flex flex-col justify-between space-y-6 cursor-pointer group relative overflow-hidden"
            >
              <div>
                ...
                <h3 className="font-heading font-bold text-2xl text-white group-hover:text-corporate-sky transition-colors mb-2">
                  {prod.name}
                </h3>
              ...
              <div className="pt-4 border-t border-navy-800 flex items-center justify-between text-xs font-bold text-corporate-sky">
      ...
      {selectedProduct && (
        <div className="fixed inset-0 z-50 bg-navy-950/85 backdrop-blur-md flex items-center justify-center p-4">
          <div className="corporate-card max-w-2xl w-full rounded-3xl border border-slate-700 p-6 sm:p-8 space-y-6 relative overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
            <button
            ...
            <div className="space-y-2">
              <span className="text-xs font-mono font-bold text-corporate-sky bg-navy-800 border border-slate-700 px-3 py-1 rounded-full uppercase">
            ...
            <div className="space-y-2 bg-navy-900 border border-navy-800 p-4 rounded-2xl">
              ...
              <div className="space-y-2">
                {selectedProduct.keySpecs.map((spec, i) => (
                  <div key={i} className="flex items-center space-x-2 text-xs font-mono text-slate-300">
                    <CheckCircle2 className="w-4 h-4 text-corporate-sky shrink-0" />
                    <span>{spec}</span>
                  </div>
                ))}
              </div>
            ...
            <div className="pt-4 border-t border-navy-800 flex items-center justify-between">
              ...
              {selectedProduct.link && selectedProduct.link !== '#' ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-6 py-2.5 rounded-xl font-heading font-bold text-xs bg-corporate-blue text-white flex items-center space-x-2 shadow-lg"
                >
                ...
                <button
                  onClick={() => setSelectedProduct(null)}
                  className="px-6 py-2.5 rounded-xl font-heading font-bold text-xs bg-navy-800 text-white hover:bg-navy-700"
                >
                  Close Modal
                </button>
              )}
